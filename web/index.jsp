      ...
      <div id="content_popup">
        <div id="content_popup_area">
          ...
          <form id="insert_form" name="insert_form">
            ...
            <label class="label_popup">Offense code group </label><input type="text" class="inputfield_pop" id="off_code_group" placeholder="(es. Auto Theft)" disabled onblur="validateOffenseCodeGroup($('#off_code_group'), 50, $('.crime_ins_txt_err').eq(2))"> <span class="crime_ins_txt_err"></span> <br>
