      ...
      <div id="content_popup">
        <div id="content_popup_area">
          ...
          <form id="insert_form" name="insert_form">
            ...
            <label class="label_popup">Offense code </label><input type="text" class="numberfield_pop" id="off_code" placeholder="(es. 1234)" min="1" maxlength="5" onblur="validateOffenseCodeAndSetOffenseCodeGroup($(this), 5, $('.crime_ins_txt_err').eq(1))"> <span class="crime_ins_txt_err"></span> <br>
            <label class="label_popup">Offense code group </label><input type="text" class="inputfield_pop" id="off_code_group" placeholder="(es. Auto Theft)" disabled onblur="validateOffenseCodeGroup($(this), 50, $('.crime_ins_txt_err').eq(2))"> <span class="crime_ins_txt_err"></span> <br>
            <label class="label_popup">Offense description </label><input type="text" class="inputfield_pop" id="off_code_desc" placeholder="(es. Auto Theft - Scooter)" maxlength="50" disabled onblur="validateOffenseDescription($(this), 50, $('.crime_ins_txt_err').eq(3))"> <span class="crime_ins_txt_err"></span> <br>
            ...
            <label class="label_popup"> Date and time </label> <input type="datetime-local" class="datetime_input" id="datetime_ins" onblur="validateOccurredDate($(this), $('.crime_ins_txt_err').eq(6))"> <span class="crime_ins_txt_err"></span><br> <!-- check campo obbligatorio -->
